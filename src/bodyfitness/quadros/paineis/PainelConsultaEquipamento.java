 ...
 * @author a1509950
 */
public class PainelConsultaEquipamento extends javax.swing.JFrame {

    /**
     * Creates new form ConsultaEquipamento
     */
    public PainelConsultaEquipamento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        criterioCBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "nome", "id", "habilitados", "desabilitados" }));
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        ...
        if (this.criterioCBox.getSelectedItem().toString().equals("nome")) {
            if (this.buscaTField.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Campo para nome está vazio", "Erro", JOptionPane.ERROR_MESSAGE);

            } else {
                List<Equipamento> equipamentos = dao.consultarPorNome(this.buscaTField.getText());
                String resultado[][] = new String[equipamentos.size()][7];
                ...
                for(int i = 0; i < equipamentos.size(); i++) {
                    ...
                    resultado[i] = new String[]{e.getId().toString(),e.getNome(),e.getPesoMinimo().toString(),e.getPesoMaximo().toString(),formato.format(e.getDataDaUltimaManutencao()),formato.format(e.getDataDaProximaManutencao()),habilitado};
                }
        ...
        else if(this.criterioCBox.getSelectedItem().toString().equals("id")) {
            Equipamento e = dao.consultarPorId(Long.valueOf(this.buscaTField.getText()));
            String resultado[][] = new String[1][7];
                SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                    String habilitado;
                    if(e.isHabilitado()) {
                        habilitado = "habilitado";
                    ...
                    resultado[0] = new String[]{e.getId().toString(),e.getNome(),e.getPesoMinimo().toString(),e.getPesoMaximo().toString(),formato.format(e.getDataDaUltimaManutencao()),formato.format(e.getDataDaProximaManutencao()),habilitado};
        ...
        else if(this.criterioCBox.getSelectedItem().toString().equals("habilitados")) {
            List<Equipamento> equipamentos = dao.consultaHabilitado();
            String resultado[][] = new String[equipamentos.size()][7];
                SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                for(int i = 0; i < equipamentos.size(); i++) {
                    Equipamento e = equipamentos.get(i);
        ...
        else if (this.criterioCBox.getSelectedItem().toString().equals("desabilitados")) {
            List<Equipamento> equipamentos = dao.consultaNaoHabilitado();
            String resultado[][] = new String[equipamentos.size()][7];
                SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                for(int i = 0; i < equipamentos.size(); i++) {
                    Equipamento e = equipamentos.get(i);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PainelConsultaEquipamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PainelConsultaEquipamento().setVisible(true);
            }
        });
    }
