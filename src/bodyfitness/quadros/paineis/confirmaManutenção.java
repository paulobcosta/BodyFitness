 ...
 * @author a1509950
 */
public class confirmaManutenção extends javax.swing.JFrame {

    /**
     * Creates new form confirmaManutenção
     */
    public confirmaManutenção() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(confirmaManutenção.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new confirmaManutenção().setVisible(true);
            }
        });
    }
